...
//    if ($old_article->nid == 2300) {
      ...
      $node->field_os2web_base_field_ext_link = $old_article->field_os2web_base_field_ext_link;

      $node->field_os2web_base_hide_contact = $old_article->field_os2web_base_hide_contact;
      $node->field_os2web_base_hide_sidebar = $old_article->field_os2web_base_hide_sidebar;
      ...
      $node->field_os2web_base_field_struct = $old_article->field_os2web_base_field_struct;
      $node->field_os2web_base_field_promote = $old_article->field_os2web_base_field_promote;
      $node->field_os2web_base_field_weight = $old_article->field_os2web_base_field_weight;

      $node->field_borger_dk_kle = $old_article->field_os2web_base_field_kle_ref;
